...
static void	handle_redir_in(t_cmd *cmd, t_redir_list *redir);
static void	handle_redir_out(t_cmd *cmd, t_redir_list *redir);
static void	handle_redir_append(t_cmd *cmd, t_redir_list *redir);
